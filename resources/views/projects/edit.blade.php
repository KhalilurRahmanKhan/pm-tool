...
<div class="role-form">
    <div class="" style="width:100%;">
        ...
        <input autofocus class="input-div-full" name="name" id="" cols="30" rows="5" value="{{$project->name}}"></input><br>
        @error('name')
...
<div class="role-form">
    ...
    <div class="input-div">
        ...
        <input type="text"  name="initiated_for" value="{{$project->initiated_for}}" ><br>
        @error('initiated_for')
                <small class="text-danger">{{$message}}</small>
            @enderror
    </div>
...
<div class="input-div">
        ...
        <select name="project_owner" id="">
            <option value="{{$project->project_owner}}" selected>Select one</option>
